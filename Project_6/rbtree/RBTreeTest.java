 ...
 */
    public void testAll(Tester t) {
        ...
        // add
        t.checkExpect(leaf1.add("x"),
                RBTree.node("x", leaf1, leaf1, c1, "red"));
        t.checkExpect(leaf2.add("x"),
                RBTree.node("x", leaf2, leaf2, c2, "red"));
        ...
        t.checkExpect(node1.add("aaaaaaa"),
                RBTree.node("yyyy", RBTree.node("xx",
                leaf1, leaf1, c1, "black"), RBTree.node("zzzzzz", leaf1,
                    RBTree.node("aaaaaaa",
                        leaf1, leaf1, c1, "red"), c1, "black"), c1,
                "red"));
        t.checkExpect(node1.add("aaaaa"), RBTree.node("yyyy", RBTree.node("xx",
                leaf1, leaf1, c1, "black"),
                RBTree.node("zzzzzz",
                        RBTree.node("aaaaa", leaf1, leaf1, c1, "red"),
                        leaf1, c1, "black"), c1, "red"));
        t.checkExpect(node1.add("aaa"),
                RBTree.node("yyyy", RBTree.node("xx", leaf1,
                RBTree.node("aaa", 
                        leaf1, leaf1, c1, "red"), c1, "black"), RBTree
                .node("zzzzzz", leaf1, leaf1, c1, "black"), c1, "red"));
        ...
        t.checkExpect(node01.add("g"),
                RBTree.node("d",
                        RBTree.node("b", leaf2, leaf2, c2, "black"), RBTree
                        .node("f", leaf2,
        ...
        t.checkExpect(node01.add("e"), RBTree.node("d", RBTree.node("b", leaf2,
                ...
                c2, "red"));
        t.checkExpect(node01.add("c"), RBTree.node("d", RBTree.node("b", leaf2,
                RBTree.node("c",
                        leaf2, leaf2, c2, "red"), c2, "black"), RBTree.node(
        ...
        t.checkExpect(RBTree.node("1", leaf1, leaf1, c1, "blue").repOK(),
                false);
        t.checkExpect(
        ...
        t.checkExpect(new Node("r", leaf1, leaf1, c1, "r").hasDup(), false);
        t.checkExpect(new Node("r", new Node("r", leaf1, leaf1, c1, "black"),
                new Node("ra", leaf1, leaf1, c1, "black"), c1, "black")
                .hasDup(), true);
        t.checkExpect(
                new Node("ra", new Node("r", leaf1, leaf1, c1, "black"),
                        new Node("r", leaf1, leaf1, c1, "black"), c1, "black")
                        .hasDup(), true);
        t.checkExpect(
                new Node("r", new Node("ra", leaf1, leaf1, c1, "black"),
                        new Node("r", leaf1, leaf1, c1, "black"), c1, "black")
                        .hasDup(), true);
        ...
        t.checkExpect(new Node("1", new Node("2", new Node("4", leaf1, leaf1,
                c1, "black"), leaf1, c1, "red"), new Node("3", leaf1, leaf1,
                    c1, "black"), c1, "black").maxBlack(), 2);
        t.checkExpect(new Node("1", new Node("2", leaf1, new Node("4", leaf1,
                leaf1, c1, "black"), c1, "red"), new Node("3", leaf1, leaf1,
                    c1, "black"), c1, "black").maxBlack(), 2);
        t.checkExpect(new Node("1", new Node("2", leaf1, leaf1, c1, "red"),
                new Node("3", new Node("4", leaf1, leaf1, c1, "black"), leaf1,
                        c1, "black"), c1, "black").maxBlack(), 3);
        t.checkExpect(new Node("1", new Node("2", leaf1, leaf1, c1, "red"),
                new Node("3", leaf1, new Node("4", leaf1, leaf1, c1, "black"),
                        c1, "black"), c1, "black").maxBlack(), 3);
