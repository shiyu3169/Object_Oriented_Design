...
public abstract class RBTree {
     ...
     */
    public RBTree(Comparator<String> comp) {
        this.comp = comp;
    }
     ...
     * @return - the new Leaf
     */
    public static RBTree leaf(Comparator<String> comp) {
     ...
     * @return - the new Node
     */
    public static RBTree node(String data, RBTree left, RBTree right,
            Comparator<String> comp, String color) {
        return new Node(data, left, right, comp, color);
    }
     ...
     * */
    public abstract RBTree add(String it);
    ...
    public boolean equals(Object o) {
        ...
        RBTree b = (RBTree) o;
        if (((RBTree) b).buildList().size() != this.buildList().size()) {
            return false;
        } 
        if (((RBTree) b).isLeaf()) {
            return this.isLeaf();
